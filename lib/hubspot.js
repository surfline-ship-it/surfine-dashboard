...
export const PIPELINE_PROGRESSION_ROW_ORDER = [
  {
    ...
    matchStageIds: ["3471215350", "3471215351"],
  ...
  {
    rowId: "qual-call-scheduling",
    label: "Qualification Calls Scheduled",
    matchStageIds: ["3471208175"],
    rowClass: "pipeline-row-early",
    alwaysVisible: false,
  },
  {
...
function pipelineStageToRowId(stage) {
  ...
  if (!s) return null;
  if (s === "3471215350" || s === "3471215351") return "engaged-in-pursuit";
  if (s === "3501326047") return "engaged-longterm";
  if (s === "3471208175") return "qual-call-scheduling";
