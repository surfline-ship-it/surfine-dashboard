...
export async function getInterestedCompanyCount(partner, searchName) {
  const filters = [{ propertyName: "interested", operator: "EQ", value: "true" }];
  if (partner) filters.push({ propertyName: "partner", operator: "EQ", value: partner });
  if (searchName) {
    filters.push({ propertyName: "search_name", operator: "EQ", value: searchName });
  }
...
export async function getTotalOutboundCalls(partner, searchName) {
  const filters = [{ propertyName: "hs_call_direction", operator: "EQ", value: "OUTBOUND" }];
  if (partner) filters.push({ propertyName: "partner", operator: "EQ", value: partner });
  if (searchName) {
    filters.push({ propertyName: "search_name", operator: "EQ", value: searchName });
  }
