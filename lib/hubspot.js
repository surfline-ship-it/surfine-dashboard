...
export function computeMetrics(contacts, deals, callData, searchFilter) {
  ...
  // Qualification calls held = deals through Partner Discussions (pipeline qual / progression)
  const qualStages = ["3220310749", "3220310750", "3220310751", "3220310752", "3253863104", "closedwon"];
  ...
  const introStages = ["3220310751", "3220310752", "3253863104", "closedwon"];
  ...
  const activeStages = ["3220310749", "3220310750", "3220310751", "3220310752", "3253863104", "closedwon"];
