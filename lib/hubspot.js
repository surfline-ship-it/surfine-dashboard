...
/**
 * Pipeline UI: 6 consolidated rows (rolled-up HubSpot stages).
 * Hidden stages: 3471208176, 3501326047, closedlost — deals in those stages are omitted from this list.
 */
export const PIPELINE_PROGRESSION_STAGES = [
  {
    rowId: "pre-qual-booking",
    label: "Pre-Qual Booking",
    hubspotStageIds: ["3471208175"],
    rowClass: "pipeline-row-early",
  },
  {
    rowId: "qual-scheduling",
    label: "Qualification Call Held / Scheduling",
    hubspotStageIds: ["3220310749", "3471215350", "3471215351"],
    rowClass: "pipeline-row-early",
  },
  {
    rowId: "teaser-sent",
    label: "Teaser Sent",
    hubspotStageIds: ["3220310750", "3220310751"],
...
function buildPipelineProgression(filteredDeals) {
  const hidden = new Set(["3471208176", "3501326047", "closedlost"]);
